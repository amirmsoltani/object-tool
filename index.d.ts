...
declare module "etch" {
     ...
     */
    export default function etch<T = {
        [key: string]: any;
...
declare module "every" {
     ...
     * false
     */
    export default function every<T extends {
        [key: string]: any;
...
declare module "exists" {
    /**
     ...
     false
     */
    export default function exists<T extends {
        [key: string]: any;
    }>(ob: T, query: {
...
declare module "mapToArray" {
     ...
     */
    export default function mapToArray<T extends {
        [key: string]: any;
...
declare module "keys" {
     ...
     * ["one","tow","three"]
     */
    export default function keys<T = {
        [key: string]: any;
    }>(ob: T): Array<keyof T>;
}
declare module "union" {
     ...
     */
    export default function union<T extends {
        [key: string]: any;
    }>(...args: T[]): {
